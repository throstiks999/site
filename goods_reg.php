...
<style = "">
	...
	<title>Website</title>
	<link rel="stylesheet" href="css/style_goods_reg.css">
...
<form action="" id="form" class="popup">
<select class="choice1" name="Способ">
<option>С доставкой (только по городу)</option>
<option>Без доставки</option>
</select>
<div class="formGood">
<label for="formGoods" class="ua" name="Name Goods">Yolla</label>
<input id="formGoods" type="text" name="Yolla" class="formGood">
</div>
...
<a href="loll.php" alt="Для того чтобы сделать заказ, нужно войти!" class="pho" title="Для того чтобы сделать заказ, нужно войти!">Заказать</a>
<input type="date" class="date" name="date" value="2020-11-20" max="2020-12-20" min="2020-11-27" >
...
<div class="social">
		...
		<div class="social-menu">
			...
			<a href="main_reg.php" class="connect">< На главную</a>
